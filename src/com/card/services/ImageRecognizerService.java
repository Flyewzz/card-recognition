...
import com.card.Constants;

import java.awt.*;
import java.awt.image.BufferedImage;
import java.util.stream.IntStream;

import static com.card.Constants.ARRAY_RGB_OF_SHADOW_CARD_SURFACE;
...
public class ImageRecognizerService {
    ...
    public static int getCompareIndexOfSubImages(BufferedImage img1,
        ...
        changeColor(img11, ARRAY_RGB_OF_SHADOW_CARD_SURFACE,
    ...
    //Получить пороговое значения для бинаризации
